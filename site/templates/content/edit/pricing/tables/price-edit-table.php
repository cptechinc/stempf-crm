...
<h4>Edit Price</h4>
<table class="table table-bordered table-striped table-condensed">
    <tr> <td class="control-label">Qty</td> <td><input type="text" class="form-control pull-right input-sm text-right qty" name="qty" value="<?= $linedetail['qtyordered']+0; ?>"></td> </tr>
    <tr>
        <td class="control-label">Price</td>
        <td>
            <div class="input-group">
                <div class="input-group-addon input-sm">$ </div>
                <input type="text" class="form-control input-sm text-right price" name="price" value="<?= formatmoney($linedetail['price']); ?>">
            </div>
        </td>
    </tr>
    ...
    <?php if ($soconfig['config']['use_discount']) : ?>
        <tr>
            ...
            <td>
                <div class="input-group">
                    <div class="input-group-addon input-sm">$</div>
                    <input type="text" class="form-control input-sm text-right discount-amt" value="<?= formatmoney(($linedetail['discpct'] / 100) * $linedetail['price']); ?>">
                </div>
            </td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <td>
            <div class="input-group">
                <div class="input-group-addon input-sm">$</div>
                <input type="text" class="form-control input-sm text-right totalprice" value="<?= formatmoney($linedetail['price'] * $linedetail['qtyordered']); ?>" disabled>
            </div>
        </td>
    </tr>
</table>

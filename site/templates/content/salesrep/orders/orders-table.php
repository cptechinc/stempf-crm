         ...
         <?php
			if ($orderby != "") {
				if ($orderby == "orderdate") {
					$orders = get_salesrep_orders_orderdate(session_id(), $config->showonpage, $input->pageNum(), $sortrule, false);
					$sql = get_salesrep_orders_orderdate(session_id(), $config->showonpage, $input->pageNum(), $sortrule, true);
				} else {

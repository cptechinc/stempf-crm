...
<?php foreach ($details as $detail) : ?>
    <?php
		...
		$detailnoteurl = $config->pages->notes.'redir/?action=get-order-notes&ordn='.$order->orderno.'&linenbr='.$detail['linenbr'];
		...
		if ($detail['haveitemdoc'] == 'Y') {
			$itemdocLink = '<a class="btn btn-primary" href="redir/cust-redir.php?action=get-order-documents&itemdoc='.$detail['itemid'].'&ordn='.$order->orderno.$linkaddon."&custID=".$cust.'">

...
<table class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<td><?php echo $customer['ccity'].', '.$customer['cst'].' '.$customer['czip']; ?> </td>
	</tr>
	<tr>
		<td class="control-label">Phone: </td>
		<td><a href="tel:<?php echo $customer['cphone']?>"><?php echo $customer['cphone']; ?></a></td>
	</tr>
	<tr>
	...
	<tr>
	 ...
	 <tr>
		...
		<td>
	    	<div class="input-group" style="width: 180px;">
	        	<div class="input-group-addon input-sm"><span class="glyphicon glyphicon-calendar"></span></div>
	        	<input type="text" placeholder="MM/DD/YYYY" class="form-control input-sm text-right" value="<?= DplusDateTime::formatdate($customer['lastsaledate']); ?>">
	        </div>
	    </td>
	 </tr>
	 <tr>
	 	<td class="control-label">Amount Sold</td>
	 	<td class="text-right">$ <?php echo formatmoney($customer['amountsold']); ?></td>
	 </tr>
	 <tr>
	 ...
	 <tr>
		...
		<td><?php echo createshopasform($custID, false) ?></td>
	 </tr>
</table>

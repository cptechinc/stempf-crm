	...
	<div class="col-xs-12">
		...
		<nav>
			<ul class="nav list-unstyled">
				...
				<li> <a href="<?php echo $config->pages->user; ?>"><i class="material-icons">&#xE851;</i> User</a> </li>
				<li> <a href="<?php echo $config->pages->iteminfo; ?>"><i class="material-icons">&#xE051;</i> Item Info</a> </li>
				<li> <a href="<?php echo $config->pages->custinfo; ?>"><i class="fa fa-users" aria-hidden="true"></i> Cust Info</a> </li>
				...
				<li> <a href="<?php echo $config->pages->documentation; ?>"> <i class="fa fa-book" aria-hidden="true"></i> Documentation</a> </li>

				<li class="divider"></li>
				<li class="dropdown-header">Categories</li>
				<?php if ($user->loggedin) : ?>
				<li class="logout">
					<a href="<?php echo $config->pages->account; ?>redir/?action=logout" class="logout">
